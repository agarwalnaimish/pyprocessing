...
def noise(*args):
    ...
    BA = perlin[B] + Z
    BB = perlin[B + 1] + Z
    return __plerp(w, __plerp(v, __plerp(u, __grad(perlin[AA], x, y, z),
                                         __grad(perlin[BA], x - 1, y, z)),
                              __plerp(u, __grad(perlin[AB], x, y - 1, z),
                                      __grad(perlin[BB], x - 1, y - 1, z))),
                   __plerp(v, __plerp(u, __grad(perlin[AA + 1], x, y, z - 1),
                                      __grad(perlin[BA + 1], x - 1, y, z - 1)),
                           __plerp(u, __grad(perlin[AB + 1], x, y - 1, z - 1),
                                   __grad(perlin[BB + 1], x - 1, y - 1,
                                          z - 1))))
...
if __name__ == '__main__':
    ...
    print(list(map(25, 0, 100, 100, 300)))
    print(norm(25, 0, 100))
    print(mag(1, 1, 1))
